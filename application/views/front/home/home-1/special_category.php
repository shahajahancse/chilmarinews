...
<section class="page-section with-sidebar pad-tb-5" style="margin-top:20px;">
    <div class="container-fluid bg-info">
        <div class="row mar-lr--5">
            <!-- SIDEBAR -->
            <!-- <aside class="col-md-3 hidden-sm hidden-xs sidebar < ?php if($special_category_data['sidebar'] == 'right'){ echo 'pull-left'; } ?>" id="sidebar">
            ...
            <div class="col-lg-12 col-md-9 col-sm-12 col-xs-12 content" id="content">
                <div class="row">
                    <h3 style="margin-left:20px">  বিশেষ প্রতিবেদন</h3>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="row">
                                        ...
                                        ?> -->
                        <!-- <div class="col-md-12">
                            < ?phpecho $this->Html_model->news_box('sqr_md','1',$row2);?>
                        </div> -->
                        <!-- < ?php }
                        else{ ?> -->
                        <div class="col-md-12 mar-t-5">
                            <?php
                                echo $this->Html_model->news_box('rect_sm','1',$cat2[1]);
                            ?>
                        </div>
                            <!-- < ?php
								}
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="col-md-12 mar-t-5">
                            <?php
                                echo $this->Html_model->news_box('rect_sm','1',$cat2[2]);
                            ?>
                        </div>
                            <!-- < ?php
								}
